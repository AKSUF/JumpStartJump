      ...
      <div className="   h-full w-full left-0 top-2 z-20   ">
          <div className="">
            ...
            <li className="p-4 border-b border-gray-600 dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/storemanager/home">
                <HomeIcon className="inline-block mr-2 mb-2 " />
                Home
              </NavLink>
            </li>
            <li className="p-4 border-b border-gray-600 dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/storemanager/showproducts">
                <StorefrontIcon className="inline-block ml-0 mr-2 mb-2  " />
                Product
              </NavLink>
            </li>
             <li className="p-4 border-b border-gray-600 dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/storemanager/addProduct">
                <AddBoxIcon className="inline-block ml-0 mr-2 mb-2  " />
                Add Product
              </NavLink>
            </li>
            <li className="p-4 border-b border-gray-600 dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/storemanager/myStore">
                <AddBoxIcon className="inline-block ml-0 mr-2 mb-2  " />
              StoreProduct
              </NavLink>
            </li>
            <li className="p-4 border-b border-gray-600 dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/storemanager/showAllAcceptedRequest">
                <AddBoxIcon className="inline-block ml-0 mr-2 mb-2  " />
             ShowRequest
              </NavLink>
            </li>
            ...
            <li className="p-4 border-gray-600 hover:border-b dark:hover:border-gray-400 dark:hover:text-green-400">
              <NavLink to="/register">
