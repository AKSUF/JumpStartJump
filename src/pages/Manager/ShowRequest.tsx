...
import { getAllOrders,getAllRiders } from '../../service/deliveryService';
...
const handleFormSubmit = async (event:any) => {
  ...
  return (
    ...
    >
      ...
      {riders.map((rider: User) => (
        <MenuItem key={rider.user_id} value={rider.user_id}>
          {rider.name}
        </MenuItem>
      ))}
    </Select>
    ...
    <TableHead>
      <TableRow>
        ...
        <TableCell>Send Deliveryman</TableCell>
      </TableRow>
    </TableHead>
    <TableBody>
  ...
  <form onSubmit={handleFormSubmit}>
    <div className='flex'>
      <div>
      <Select
value={typeof selectedRider === 'string' ? selectedRider : selectedRider?.user_id || ''}
